...
The user may have an OpenRouter key for this benchmark exported globally in `~/.zshrc`. A fresh shell may already have `OPENROUTER_API_KEY` available. If it's somehow not set, re-source the shell:
